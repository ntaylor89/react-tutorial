# React Tutorial
This is code from the official [React tutorial](https://facebook.github.io/react/tutorial/tutorial.html),
boostrapped with [Create React App](https://github.com/facebookincubator/create-react-app).

Some of the code has been slightly modified to use some ES6 niceties and adhere to [standardJS](https://standardjs.com/index.html)
style.
